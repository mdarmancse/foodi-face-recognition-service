...
import { RekognitionClient as RekognitionClientSdk } from "@aws-sdk/client-rekognition";
...
export const RekognitionClient = new RekognitionClientSdk({
...
export const singleUpload = (fieldName: string) => uploader.single(fieldName);

export const multiUpload = (fieldName: string) => uploader.array(fieldName);
